...
urlpatterns = [
    ...
    url(r'^userShowOrder/$',views.userShowOrder,name='userShowOrder'),
    url(r'^userShowComments/$',views.userShowComments,name='userShowComments'),
    url(r'^userAddProducte/$',views.userAddProducte,name='userAddProducte'),
    url(r'^userShowProductDetial/(?P<pk>\d+)/$', views.userShowProductDetial, name='userShowProductDetial'),
    url(r'^deleteUserComments/(?P<pk>\d+)/$', views.deleteUserComments, name='deleteUserComments'),
    url(r'^userUpdate/$',views.userUpdate,name='userUpdate'),
    url(r'^showCart/$',views.showCart,name='showCart'),
    url(r'^sss/$',views.faq,name='faq'),
    url(r'^searchProduct/$',views.searchProduct,name='searchProduct'),
    url(r'^searchProduct/auto$',views.auto_search_product, name='searchProductAuto'),
